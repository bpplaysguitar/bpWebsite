...
function Project3() {
  ...
  <h2 className="container pb-2 pt-4 border-bottom" id="project3">Project 3</h2>
    ...
    <div className="container my-4" id="downloadPDF">
      ...
      Describe the stakeholders, marketers, surgeons and their needs. We learned that surgeons overwhelmingly viewed our site on mobile, so we had to make sure to go mobile-first thinking. Different designs for desktop
      </p>
    </div>
