...
function Project1() {
  ...
  <h2 className="container pb-2 pt-4 border-bottom" id="project1">Marketing Campaign Landing Page for Surgical Devices</h2>
    ...
    <img className="desktop-only mx-auto img-fluid shadow border border-3 border-dark mb-3 rounded" alt="Screenshot of standard corporate landing page template, showing basic design" src={eloquaTemplateDesktop} />
    <img className="mobile-only mx-auto img-fluid shadow border border-3 border-dark mb-3 rounded" alt="Screenshot of standard corporate landing page template, showing basic design" src={eloquaTemplateMobile} />
    ...
    <p>
      ...
      <img className="desktop-only mx-auto img-fluid shadow border border-3 border-dark mb-3 rounded" alt="Screenshot of new landing page, customized with more image content and more interesting layout" src={prevenaDemoDesktop} />
     
      <img className="mobile-only mx-auto img-fluid shadow border border-3 border-dark mb-3 rounded" alt="Screenshot of new landing page, customized with more image content and more interesting layout" src={prevenaDemoMobile} />
      ...
      <img className="desktop-only mx-auto img-fluid shadow border border-3 border-dark mb-3 rounded" alt="Closeup detail of JavaScript button on landing page" src={prevenaArrowDesktop} />
      <img className="mobile-only mx-auto img-fluid shadow border border-3 border-dark mb-3 rounded" alt="Closeup detail of purple JavaScript button on landing page" src={prevenaArrowMobile} />
